...
<html>
  <head>
    ...
    <title>高校人事管理系统——查看自己提交的信息人才审核</title>
	...
	<script language="javascript" type="text/javascript">
		 ...
		 function toadd(){
		    var url="${pageContext.request.contextPath}/teachers.do?flag=addStrain"
		    to(url);
		 }
		 function submitgo(){//分页GO
		    	...
		    	document.forms[0].action="${pageContext.request.contextPath}/teachers.do?flag=strainManage&pageNow="+pageNow;
				...
				<% 
					...
					<tr>
						...
						<td class="list_data_op">
							<img onClick="del('确定要删除此项提交的审核吗','${pageContext.request.contextPath}/teachers.do?flag=delScheck&id=<%=scheck.getId() %>');"
								...
								<div class="pager">
									...
									<c:if test="${pageNow!=1}">
										<img src="${pageContext.request.contextPath}/images/first.gif"
											onClick="location.href='${pageContext.request.contextPath}/teachers.do?flag=strainManage&pageNow=1'"
											style="cursor: pointer" />
										<img src="${pageContext.request.contextPath}/images/back.gif"
											onClick="location.href='${pageContext.request.contextPath}/teachers.do?flag=strainManage&pageNow=${pageNow-1}'"
											style="cursor: pointer" />
									</c:if>
									<!-- 如果不是尾页 -->
									<c:if test="${pageNow!=pageCount}">
										<img src="${pageContext.request.contextPath}/images/next.gif" onClick="location.href='${pageContext.request.contextPath}/teachers.do?flag=strainManage&pageNow=${pageNow+1}'" style="cursor:pointer"/>
										<img src="${pageContext.request.contextPath}/images/last.gif" onClick="location.href='${pageContext.request.contextPath}/teachers.do?flag=strainManage&pageNow=${pageCount}'" style="cursor:pointer"/>
									</c:if>	
