					...
					<tr>
						...
						<td class="list_data_op">
							<%
							 ...
							 %>
							<img
								onClick="to('${pageContext.request.contextPath}/teachers.do?flag=editTeacher&id=<%= check.getId()%>');"
								title="编辑培训信息" src="${pageContext.request.contextPath}/images/bt_edit.gif" class="op_button" />
							<%} %>
							<img
								onClick="to('${pageContext.request.contextPath}/teachers.do?flag=queryTeacher&id=<%=check.getId() %>');"
								title="查询培训信息" src="${pageContext.request.contextPath}/images/bt_detail.gif" class="op_button" />
								...
								<div class="pager">
									...
									<c:if test="${pageNow!=1}">
										<img src="${pageContext.request.contextPath}/images/first.gif"
											onClick="location.href='${pageContext.request.contextPath}/teachers.do?flag=teacherManage&pageNow=1'"
											style="cursor: pointer" />
										<img src="${pageContext.request.contextPath}/images/back.gif"
											onClick="location.href='${pageContext.request.contextPath}/teachers.do?flag=teacherManage&pageNow=${pageNow-1}'"
											style="cursor: pointer" />
									</c:if>
									<!-- 如果不是尾页 -->
									<c:if test="${pageNow!=pageCount}">
										<img src="${pageContext.request.contextPath}/images/next.gif" onClick="location.href='${pageContext.request.contextPath}/teachers.do?flag=teacherManage&pageNow=${pageNow+1}'" style="cursor:pointer"/>
										<img src="${pageContext.request.contextPath}/images/last.gif" onClick="location.href='${pageContext.request.contextPath}/teachers.do?flag=teacherManage&pageNow=${pageCount}'" style="cursor:pointer"/>
									</c:if>	
