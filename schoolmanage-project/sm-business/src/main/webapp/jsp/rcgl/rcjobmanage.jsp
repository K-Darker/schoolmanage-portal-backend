  ...
  <head>
	...
	<script type="text/javascript">
			function submitgo(){//分页GO
		    	...
		    	document.forms[0].action="${pageContext.request.contextPath}/rcgls.do?flag=rcjobManage&pageNow="+pageNow;
					...
					<tr>
						...
						<td class="list_data_op">
							<%
							 ...
							 %>
							<img
								onClick="to('${pageContext.request.contextPath}/rcgls.do?flag=editRcjob&id=<%= rcmess.getId()%>');"
								title="编辑人才岗位信息" src="${pageContext.request.contextPath}/images/bt_edit.gif" class="op_button" />
								...
								<div class="pager">
									...
									<c:if test="${pageNow!=1}">
										<img src="${pageContext.request.contextPath}/images/first.gif"
											onClick="location.href='${pageContext.request.contextPath}/rcgls.do?flag=rcjobManage&pageNow=1'"
											style="cursor: pointer" />
										<img src="${pageContext.request.contextPath}/images/back.gif"
											onClick="location.href='${pageContext.request.contextPath}/rcgls.do?flag=rcjobManage&pageNow=${pageNow-1}'"
											style="cursor: pointer" />
									</c:if>
									<!-- 如果不是尾页 -->
									<c:if test="${pageNow!=pageCount}">
										<img src="${pageContext.request.contextPath}/images/next.gif" onClick="location.href='${pageContext.request.contextPath}/rcgls.do?flag=rcjobManage&pageNow=${pageNow+1}'" style="cursor:pointer"/>
										<img src="${pageContext.request.contextPath}/images/last.gif" onClick="location.href='${pageContext.request.contextPath}/rcgls.do?flag=rcjobManage&pageNow=${pageCount}'" style="cursor:pointer"/>
									</c:if>	
