...
<html>
  <head>
	...
	<script language="javascript" type="text/javascript">
		...
		function check(){
		  	alert("保存2");
		    document.forms[0].action="${pageContext.request.contextPath}/rcgls.do?flag=updateRcplan";
  ...
  <body>
		...
		<form id="updateRcplan" name="update" action="" method="post">
			<input type="hidden" name="rcplan_id" value="<%=rcplan.getId()%>" id="re_id"/>	
			<table class="query_form_table">
				<tr>
					...
					<td>
						<input type="text" name="rctype" size="20" value="<%=rcplan.getRctype()%>"
							id="rctype" />
					...
					<td>
						<input type="text" name="rctitle" size="20" value="<%=rcplan.getRctitle() %>"
							id="rctitle" />
							<span class="red_star">*</span>
				...
				<tr>
					...
					<td>
					<input type="text" name="rctime" size="20" value="<%=rcplan.getRctime() %>"
				...
				<tr>
					...
					<td>
						<input type="text" name="require" size="20" value="<%=rcplan.getRequire() %>"
